<?php
	...
	if (isset($_POST['submit'])) {
	    ...
	    if (!preg_match("/^[0-9]{1,3}$/",$time)) {	
			...
			echo "<br><form method='post' action=/action/timelog/" . $uid ."/" . $task_id . "><div class='white'><p class='labels'>Timelog</p> <input type='text' name='log' value=" . $time . "><span>" . $timeErr . "</span>
