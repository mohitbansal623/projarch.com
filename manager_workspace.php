    ...
    ///Query for Displaying list of workspaces for manager.
      ...
      if ($result->num_rows > 0) {
      	while($row = $result->fetch_assoc()) {
        	...
        	echo "<tr><td>" .  $row['project_name'] . "</td><td>". $row['description'] . "</a></td><td><a class='list' href=/action/listTasks/" . $wid . ">List of Task </td></a><td><a class='list'  href=/action/taskCreate/" . $wid . ">Create Task</a></td></tr>" ;
         }
         echo "<br>";
       }
        ...
        $j = 0;
          ...
          $sql = "SELECT workspace_id, project_name,  description FROM workspace WHERE workspace_id = " . $wid_arr[$j];
           ...
           // print_r($result);
            ...
            echo "<tr><td>".  $row['project_name'] . "</td><td>". $row['description'] . "</a></td><td><a class='list' href=/action/listTasks/1/" . $wid_arr[$j] . ">List of Task </td></a></tr>" ;
              $j++;
            }   
        echo "</table>"; 
      }
